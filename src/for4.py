...
user_nicknames: dict[int, list[str]] = {
    854655602503974923: ['レオ', 'クリスタルレオ', '夏帆の愛人'],
    641902369407500288: ['まる', 'ヤングケアラー丸山', 'ニーゲム大戸木', 'パイタッチコンドーム'],
    640880132101373964: ['かつ', 'かっちゃん', '手マンダーかつ', 'まさる'],
    657910904288968705: ['にこ', '親パン'],
    329959570980077569: ['ゆうと', 'ゆうと★ミ', 'ゆうと☆ミ'],
    672376985821118484: ['はなこ', '残尿', 'じょぼじょぼ', '黒川'],
    728582984684535909: ['ふくしま', 'ノーパンジー'],
    603495382051323905: ['れんま', 'は？'],
    665470238636376076: ['とも', 'ともちゃん', 'にしじま'],
    283584931437871104: ['せと', '食い込み俊介'],
}
